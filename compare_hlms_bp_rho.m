...
hplot = plot(100*HLMStrain.error(2:end), 'LineWidth', 2, 'DisplayName', ['\rho = ', sprintf('%.2f', rho)]);
...
hplot = plot(100*BPtrain.error(2:end), 'LineWidth', 2, 'DisplayName', ['\rho = ', sprintf('%.2f', rho)]);
